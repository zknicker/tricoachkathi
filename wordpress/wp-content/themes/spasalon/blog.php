...
if(is_page('oak-park-athletes') {
    echo "athletes";
    $args = array('category_name' => 'oak-park-athletes', 'post_type' => 'post','paged'=>$paged);
} else if(is_page('oak-park-coaches') {
    echo "coaches";
    $args = array('category_name' => 'oak-park-coaches', 'post_type' => 'post','paged'=>$paged);
} else {
    echo "else";
